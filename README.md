...
# Bugs
-	Float a window, give that window focus, move the window over main window, lose connection
  -	“lost connection prompt” can’t be acknowledged because it is covered by the floated window which doesn’t respond because the prompt requires acknowledgement.
...
-	Allow STRING constants within ladder code
...
##	RsLinx
-	Allow renaming of Communications drivers
##	Compare Tool
